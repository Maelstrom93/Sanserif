...
include '../partials/navbar.php'?>
  ...
  <section class="panel" style="margin-bottom:12px;">
    ...
    <div class="jobs-row" style="margin-top:12px;">
      ...
      ?>
        <article class="job-card" data-scadenza="<?= e($scadRaw) ?>">
          <div class="head">
            <h4 class="title"><?= e($titolo) ?></h4>
            <div style="display:flex; gap:6px; align-items:center;">
              <span class="prio <?= e(prio_label($r['priorita'] ?? null)) ?>"><i class="fa-solid fa-circle"></i> <?= e(prio_label($r['priorita'] ?? null)) ?></span>
          ...
          <?php if (!empty($rowsAll)): ?>
            ...
            ?>
              <tr>
                ...
                <td>
                  <span class="badge state-<?= e($stato ?: 'aperto') ?>"><?= e($stato ?: 'aperto') ?></span>
                  <span class="prio <?= e(prio_label($r['priorita'] ?? null)) ?>" style="margin-left:6px;"><i class="fa-solid fa-circle"></i> <?= e(prio_label($r['priorita'] ?? null)) ?></span>
                </td>
                <td><?= $scad ? e($scad) : '—' ?></td>
